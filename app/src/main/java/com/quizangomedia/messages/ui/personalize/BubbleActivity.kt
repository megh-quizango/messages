...
import com.quizangomedia.messages.databinding.ActivityBubbleBinding
...
class BubbleActivity : AppCompatActivity() {
    ...
    private fun setupApplyButton() {
        ...
        binding.buttonApply.setOnClickListener {
            ...
            sendBroadcast(android.content.Intent("com.quizangomedia.messages.BUBBLE_COLOR_CHANGED"))
