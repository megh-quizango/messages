...
import com.quizangomedia.messages.util.NotificationHelper
...
class NotificationActionReceiver : BroadcastReceiver() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                realm.writeBlocking {
                    ...
                    val messages = query(com.quizangomedia.messages.data.model.Message::class, "threadId == $threadId AND read == false").find()
                    messages.forEach { message ->
    ...
    private fun handleReply(context: Context, threadId: Long, address: String) {
        try {
            ...
            val intent = Intent(context, com.quizangomedia.messages.ui.conversation.ConversationDetailActivity::class.java).apply {
