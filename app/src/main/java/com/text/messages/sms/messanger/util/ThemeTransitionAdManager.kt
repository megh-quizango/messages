...
object ThemeTransitionAdManager {
    ...
    private const val TAG = "ThemeTransitionAds"
    ...
    fun preload(context: Context) {
        ...
        if (RemoteConfigHelper.shouldUseThemeNativeFullscreenOnly()) {
    ...
    fun shouldUseNativeFullscreenOnly(): Boolean {
        return RemoteConfigHelper.shouldUseThemeNativeFullscreenOnly()
    }
    ...
    private fun loadInterstitialAd(context: Context) {
        ...
        val adUnitId = AdConfig.resolveThemeInterstitialAdUnitId(context)
        if (adUnitId.isBlank()) {
            return
        }
    ...
    private fun loadNativeFullscreenAd(context: Context) {
        ...
        val adUnitId = AdConfig.resolveThemeNativeFullscreenAdUnitId(context)
        if (adUnitId.isBlank()) {
            return
        }
