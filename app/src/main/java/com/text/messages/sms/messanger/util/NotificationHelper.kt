...
import com.text.messages.sms.messanger.receiver.NotificationActionReceiver
...
import com.text.messages.sms.messanger.ui.notifications.NotificationPreview
            ...
            if (action != null && action != ButtonAction.NONE) {
                ...
                if (action == ButtonAction.REPLY) {
                    ...
                    val replyIntent = Intent(context, NotificationActionReceiver::class.java).apply {
                        setAction("com.text.messages.sms.messanger.NOTIFICATION_ACTION")
