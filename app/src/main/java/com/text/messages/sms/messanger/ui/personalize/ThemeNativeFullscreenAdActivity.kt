...
class ThemeNativeFullscreenAdActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nativeAd = ThemeTransitionAdManager.consumeNativeFullscreenAd()
        if (nativeAd == null) {
            finishAd()
            return
        }
    ...
    override fun onDestroy() {
        nativeAd?.destroy()
        nativeAd = null
        ThemeTransitionAdManager.reloadAfterNativeDismiss(applicationContext)
        super.onDestroy()
    }
}
